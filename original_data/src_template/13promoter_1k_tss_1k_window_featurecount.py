import os
os.system('mkdir ../results/1k_tss_1k_windows_feature_count')
annotation_file = '/data1/szx/metadata/gene_annotation/human/Homo_sapiens.GRCh38.93.gene.protein_coding.windows50_slide25.gtf'  
...
-o ../results/1k_tss_1k_windows_feature_count/%s_count.txt -M ../results/merge_bam/%s'%(annotation_file, sam_file.strip('.bam'), sam_file))    
    else:
